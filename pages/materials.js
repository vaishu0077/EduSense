...
export default function Materials() {
  ...
  const handleGenerateQuiz = async (material, quizSettings) => {
    try {
      // Show loading state
      toast.loading(`Generating ${quizSettings.numQuestions} questions from material...`, { id: 'quiz-generation' })
      ...
      const quizData = {
        ...
        difficulty: quizSettings.difficulty || material.ai_analysis?.difficulty_level || 'intermediate',
        timeLimit: quizSettings.timeLimit || 30,
        numQuestions: quizSettings.numQuestions || 5,
      ...
      toast.success(`Quiz generated with ${quizSettings.numQuestions} questions!`, { id: 'quiz-generation' })
    } catch (error) {
