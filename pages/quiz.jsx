...
export default function Quiz() {
  ...
  const generateQuizFromMaterial = async (quizData) => {
    try {
      // Use AI-suggested questions if available
      if (quizData.suggestedQuestions && quizData.suggestedQuestions.length > 0) {
        const questions = quizData.suggestedQuestions.map((q, index) => ({
          id: `q-${index + 1}`,
          question_text: q.question,
          question_type: 'multiple_choice',
          options: ['Option A', 'Option B', 'Option C', 'Option D'], // Generate options based on content
          correct_answer: 'Option A', // This should be generated by AI
          explanation: `This question tests understanding of ${q.topic}`,
          hints: [`Review the section on ${q.topic}`, 'Consider the main concepts discussed']
        }))
